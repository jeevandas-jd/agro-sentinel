...
class _ClaimScreenState extends State<ClaimScreen>
  ...
  Future<void> _generateReport() async {
    ...
    try {
      ...
      await Printing.layoutPdf(
        ...
        name: 'CLM-2024-001_agroSentinel_Dossier.pdf',
      );
    } catch (e) {
      if (!mounted) return;
  ...
  Future<List<int>> _buildPdf() async {
    final pdf = pw.Document(
      title: 'agroSentinel Claim Dossier — CLM-2024-001',
      author: 'agroSentinel AI System',
    );
  ...
  pw.Widget _pdfFooter(pw.Context ctx) {
    return pw.Container(
      ...
      child: pw.Row(
        ...
        children: [
          pw.Text(
            'CLM-2024-001  •  Generated by agroSentinel  •  Palakkad District, Kerala',
  ...
  pw.Widget _pdfEvidenceChain() {
    final steps = [
      ...
      (
        'GPS Truth Walk',
        'Farmer navigated to hotspot using agroSentinel • 12 Mar 2024',
      ),
      (
    ...
    return pw.Container(
      ...
      child: pw.Column(
        ...
        children: [
          ...
          pw.SizedBox(height: 6),
          pw.Text(
            'This document has been generated by the agroSentinel AI-Verified Crop Damage Assessment '
            ...
            const Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'CLM-2024-001_agroSentinel_Dossier.pdf',
